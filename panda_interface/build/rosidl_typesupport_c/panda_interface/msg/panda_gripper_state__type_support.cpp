...
static const _PandaGripperState_type_support_symbol_names_t _PandaGripperState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_interface, msg, PandaGripperState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_interface, msg, PandaGripperState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, panda_interface, msg, PandaGripperState)() {
  return &::panda_interface::msg::rosidl_typesupport_c::PandaGripperState_message_type_support_handle;
}
