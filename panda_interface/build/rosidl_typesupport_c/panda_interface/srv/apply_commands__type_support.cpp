...
static const _ApplyCommands_Request_type_support_symbol_names_t _ApplyCommands_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_interface, srv, ApplyCommands_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_interface, srv, ApplyCommands_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, panda_interface, srv, ApplyCommands_Request)() {
  return &::panda_interface::srv::rosidl_typesupport_c::ApplyCommands_Request_message_type_support_handle;
}
...
static const _ApplyCommands_Response_type_support_symbol_names_t _ApplyCommands_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_interface, srv, ApplyCommands_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_interface, srv, ApplyCommands_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, panda_interface, srv, ApplyCommands_Response)() {
  return &::panda_interface::srv::rosidl_typesupport_c::ApplyCommands_Response_message_type_support_handle;
}
...
static const _ApplyCommands_type_support_symbol_names_t _ApplyCommands_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_interface, srv, ApplyCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, panda_interface, srv, ApplyCommands)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, panda_interface, srv, ApplyCommands)() {
  return &::panda_interface::srv::rosidl_typesupport_c::ApplyCommands_service_type_support_handle;
}
