...
{
  new (message_memory) panda_interface::srv::Connect_Request(_init);
}

void Connect_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<panda_interface::srv::Connect_Request *>(message_memory);
  typed_message->~Connect_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Connect_Request_message_member_array[1] = {
  {
    ...
    offsetof(panda_interface::srv::Connect_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Connect_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(panda_interface::srv::Connect_Request),
...
{
  return &::panda_interface::srv::rosidl_typesupport_introspection_cpp::Connect_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, panda_interface, srv, Connect_Request)() {
  return &::panda_interface::srv::rosidl_typesupport_introspection_cpp::Connect_Request_message_type_support_handle;
}
...
void Connect_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) panda_interface::srv::Connect_Response(_init);
}

void Connect_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<panda_interface::srv::Connect_Response *>(message_memory);
  typed_message->~Connect_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Connect_Response_message_member_array[1] = {
  {
    "success",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(panda_interface::srv::Connect_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Connect_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(panda_interface::srv::Connect_Response),
...
{
  return &::panda_interface::srv::rosidl_typesupport_introspection_cpp::Connect_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, panda_interface, srv, Connect_Response)() {
  return &::panda_interface::srv::rosidl_typesupport_introspection_cpp::Connect_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Connect_service_members = {
  ...
  // see get_service_type_support_handle<panda_interface::srv::Connect>()
...
get_service_type_support_handle<panda_interface::srv::Connect>()
{
  ...
  auto service_type_support =
    &::panda_interface::srv::rosidl_typesupport_introspection_cpp::Connect_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, panda_interface, srv, Connect)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<panda_interface::srv::Connect>();
}
