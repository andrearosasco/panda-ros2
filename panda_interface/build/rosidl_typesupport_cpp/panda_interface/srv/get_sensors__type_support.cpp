...
static const _GetSensors_Request_type_support_symbol_names_t _GetSensors_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panda_interface, srv, GetSensors_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, panda_interface, srv, GetSensors_Request)),
  }
};
...
{
  return &::panda_interface::srv::rosidl_typesupport_cpp::GetSensors_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, panda_interface, srv, GetSensors_Request)() {
  return get_message_type_support_handle<panda_interface::srv::GetSensors_Request>();
}
...
static const _GetSensors_Response_type_support_symbol_names_t _GetSensors_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panda_interface, srv, GetSensors_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, panda_interface, srv, GetSensors_Response)),
  }
};
...
{
  return &::panda_interface::srv::rosidl_typesupport_cpp::GetSensors_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, panda_interface, srv, GetSensors_Response)() {
  return get_message_type_support_handle<panda_interface::srv::GetSensors_Response>();
}
...
static const _GetSensors_type_support_symbol_names_t _GetSensors_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, panda_interface, srv, GetSensors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, panda_interface, srv, GetSensors)),
  }
};
...
{
  return &::panda_interface::srv::rosidl_typesupport_cpp::GetSensors_service_type_support_handle;
}
