...
#ifndef PANDA_INTERFACE__SRV__DETAIL__CONNECT_GRIPPER__FUNCTIONS_H_
#define PANDA_INTERFACE__SRV__DETAIL__CONNECT_GRIPPER__FUNCTIONS_H_
...
/// Initialize srv/ConnectGripper message.
/**
...
/// Finalize srv/ConnectGripper message.
/**
...
/// Create srv/ConnectGripper message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * panda_interface__srv__ConnectGripper_Request__init().
...
/// Destroy srv/ConnectGripper message.
/**
 * It calls
 * panda_interface__srv__ConnectGripper_Request__fini()
...
/// Check for srv/ConnectGripper message equality.
/**
...
/// Copy a srv/ConnectGripper message.
/**
...
/// Initialize array of srv/ConnectGripper messages.
/**
...
/// Finalize array of srv/ConnectGripper messages.
/**
 * It calls
 * panda_interface__srv__ConnectGripper_Request__fini()
...
/// Create array of srv/ConnectGripper messages.
/**
 * It allocates the memory for the array and calls
 * panda_interface__srv__ConnectGripper_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ConnectGripper messages.
/**
 * It calls
 * panda_interface__srv__ConnectGripper_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ConnectGripper message array equality.
/**
...
/// Copy an array of srv/ConnectGripper messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * panda_interface__srv__ConnectGripper_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panda_interface
...
/**
 * It calls
 * panda_interface__srv__ConnectGripper_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_panda_interface
...
/**
 * It allocates the memory for the array and calls
 * panda_interface__srv__ConnectGripper_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_panda_interface
...
/**
 * It calls
 * panda_interface__srv__ConnectGripper_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PANDA_INTERFACE__SRV__DETAIL__CONNECT_GRIPPER__FUNCTIONS_H_
