...
panda_interface__srv__ApplyCommands_Request__init(panda_interface__srv__ApplyCommands_Request * msg)
{
  ...
  // command
  if (!panda_interface__msg__PandaCommand__init(&msg->command)) {
    panda_interface__srv__ApplyCommands_Request__fini(msg);
    return false;
  }
  return true;
}
...
panda_interface__srv__ApplyCommands_Request__fini(panda_interface__srv__ApplyCommands_Request * msg)
{
  ...
  // command
  panda_interface__msg__PandaCommand__fini(&msg->command);
}
...
panda_interface__srv__ApplyCommands_Request__are_equal(const panda_interface__srv__ApplyCommands_Request * lhs, const panda_interface__srv__ApplyCommands_Request * rhs)
{
  ...
  // command
  if (!panda_interface__msg__PandaCommand__are_equal(
...
panda_interface__srv__ApplyCommands_Request__create()
{
  ...
  panda_interface__srv__ApplyCommands_Request * msg = (panda_interface__srv__ApplyCommands_Request *)allocator.allocate(sizeof(panda_interface__srv__ApplyCommands_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(panda_interface__srv__ApplyCommands_Request));
  bool success = panda_interface__srv__ApplyCommands_Request__init(msg);
  if (!success) {
...
panda_interface__srv__ApplyCommands_Request__Sequence__init(panda_interface__srv__ApplyCommands_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_interface__srv__ApplyCommands_Request * data = NULL;

  if (size) {
    data = (panda_interface__srv__ApplyCommands_Request *)allocator.zero_allocate(size, sizeof(panda_interface__srv__ApplyCommands_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = panda_interface__srv__ApplyCommands_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        panda_interface__srv__ApplyCommands_Request__fini(&data[i - 1]);
      }
...
panda_interface__srv__ApplyCommands_Request__Sequence__fini(panda_interface__srv__ApplyCommands_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      panda_interface__srv__ApplyCommands_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_interface__srv__ApplyCommands_Request__Sequence * array = (panda_interface__srv__ApplyCommands_Request__Sequence *)allocator.allocate(sizeof(panda_interface__srv__ApplyCommands_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = panda_interface__srv__ApplyCommands_Request__Sequence__init(array, size);
  if (!success) {
...
panda_interface__srv__ApplyCommands_Request__Sequence__destroy(panda_interface__srv__ApplyCommands_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    panda_interface__srv__ApplyCommands_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
panda_interface__srv__ApplyCommands_Request__Sequence__are_equal(const panda_interface__srv__ApplyCommands_Request__Sequence * lhs, const panda_interface__srv__ApplyCommands_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!panda_interface__srv__ApplyCommands_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  panda_interface__srv__ApplyCommands_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(panda_interface__srv__ApplyCommands_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    panda_interface__srv__ApplyCommands_Request * data =
      (panda_interface__srv__ApplyCommands_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!panda_interface__srv__ApplyCommands_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          panda_interface__srv__ApplyCommands_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!panda_interface__srv__ApplyCommands_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_interface__srv__ApplyCommands_Response * msg = (panda_interface__srv__ApplyCommands_Response *)allocator.allocate(sizeof(panda_interface__srv__ApplyCommands_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(panda_interface__srv__ApplyCommands_Response));
  bool success = panda_interface__srv__ApplyCommands_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
panda_interface__srv__ApplyCommands_Response__destroy(panda_interface__srv__ApplyCommands_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    panda_interface__srv__ApplyCommands_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
panda_interface__srv__ApplyCommands_Response__Sequence__init(panda_interface__srv__ApplyCommands_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_interface__srv__ApplyCommands_Response * data = NULL;

  if (size) {
    data = (panda_interface__srv__ApplyCommands_Response *)allocator.zero_allocate(size, sizeof(panda_interface__srv__ApplyCommands_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = panda_interface__srv__ApplyCommands_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        panda_interface__srv__ApplyCommands_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
panda_interface__srv__ApplyCommands_Response__Sequence__fini(panda_interface__srv__ApplyCommands_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      panda_interface__srv__ApplyCommands_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_interface__srv__ApplyCommands_Response__Sequence * array = (panda_interface__srv__ApplyCommands_Response__Sequence *)allocator.allocate(sizeof(panda_interface__srv__ApplyCommands_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = panda_interface__srv__ApplyCommands_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
panda_interface__srv__ApplyCommands_Response__Sequence__destroy(panda_interface__srv__ApplyCommands_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    panda_interface__srv__ApplyCommands_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
panda_interface__srv__ApplyCommands_Response__Sequence__are_equal(const panda_interface__srv__ApplyCommands_Response__Sequence * lhs, const panda_interface__srv__ApplyCommands_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!panda_interface__srv__ApplyCommands_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  panda_interface__srv__ApplyCommands_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(panda_interface__srv__ApplyCommands_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    panda_interface__srv__ApplyCommands_Response * data =
      (panda_interface__srv__ApplyCommands_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!panda_interface__srv__ApplyCommands_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          panda_interface__srv__ApplyCommands_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!panda_interface__srv__ApplyCommands_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
