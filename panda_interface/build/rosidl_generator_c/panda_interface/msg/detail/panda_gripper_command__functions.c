...
panda_interface__msg__PandaGripperCommand__create()
{
  ...
  panda_interface__msg__PandaGripperCommand * msg = (panda_interface__msg__PandaGripperCommand *)allocator.allocate(sizeof(panda_interface__msg__PandaGripperCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(panda_interface__msg__PandaGripperCommand));
  bool success = panda_interface__msg__PandaGripperCommand__init(msg);
  if (!success) {
...
panda_interface__msg__PandaGripperCommand__destroy(panda_interface__msg__PandaGripperCommand * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    panda_interface__msg__PandaGripperCommand__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
panda_interface__msg__PandaGripperCommand__Sequence__init(panda_interface__msg__PandaGripperCommand__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_interface__msg__PandaGripperCommand * data = NULL;

  if (size) {
    data = (panda_interface__msg__PandaGripperCommand *)allocator.zero_allocate(size, sizeof(panda_interface__msg__PandaGripperCommand), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = panda_interface__msg__PandaGripperCommand__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        panda_interface__msg__PandaGripperCommand__fini(&data[i - 1]);
      }
...
panda_interface__msg__PandaGripperCommand__Sequence__fini(panda_interface__msg__PandaGripperCommand__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      panda_interface__msg__PandaGripperCommand__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_interface__msg__PandaGripperCommand__Sequence * array = (panda_interface__msg__PandaGripperCommand__Sequence *)allocator.allocate(sizeof(panda_interface__msg__PandaGripperCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = panda_interface__msg__PandaGripperCommand__Sequence__init(array, size);
  if (!success) {
...
panda_interface__msg__PandaGripperCommand__Sequence__destroy(panda_interface__msg__PandaGripperCommand__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    panda_interface__msg__PandaGripperCommand__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
panda_interface__msg__PandaGripperCommand__Sequence__are_equal(const panda_interface__msg__PandaGripperCommand__Sequence * lhs, const panda_interface__msg__PandaGripperCommand__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!panda_interface__msg__PandaGripperCommand__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  panda_interface__msg__PandaGripperCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(panda_interface__msg__PandaGripperCommand);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    panda_interface__msg__PandaGripperCommand * data =
      (panda_interface__msg__PandaGripperCommand *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!panda_interface__msg__PandaGripperCommand__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          panda_interface__msg__PandaGripperCommand__fini(&output->data[i]);
        }
        return false;
      }
    }
